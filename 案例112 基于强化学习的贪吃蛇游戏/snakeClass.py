...
def define_parameters():
    ...
    # Settings
    params['weights_path'] = 'D:/Project/ml_toolset/snake-ga-master/weights/weights.h5'
    params['train'] = False
    params["test"] = True
    params['plot_score'] = True
    params['log_path'] = 'D:/Project/ml_toolset/snake-ga-master/weights/logs/scores_' + str(datetime.datetime.now().strftime("%Y%m%d%H%M%S")) +'.txt'
    return params
...
class Game:
    ...
    def __init__(self, game_width, game_height):
        ...
        self.bg = pygame.image.load("D:/Project/ml_toolset/snake-ga-master/img/background.png")
        self.crash = False
...
class Player(object):
    def __init__(self, game):
        ...
        self.food = 1
        self.eaten = False
        self.image = pygame.image.load('D:/Project/ml_toolset/snake-ga-master/img/snakeBody.png')
        self.x_change = 20
        self.y_change = 0
...
class Food(object):
    def __init__(self):
        self.x_food = 240
        self.y_food = 200
        self.image = pygame.image.load('D:/Project/ml_toolset/snake-ga-master/img/food2.png')
