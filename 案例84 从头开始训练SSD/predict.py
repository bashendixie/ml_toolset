...
ap.add_argument("-i", "--image", required=False, help="path to input image", default="C:/Users/zyh/Desktop/2.png")
...
for (box, score, label) in zip(boxes, scores, labels):
    ...
    label = "ccc"#categoryIdx[label]
    idx = 0#int(label["id"]) - 1
...
#
# image_np = np.load_image_into_numpy_array(args["image"])
