...
model = load_model("study_efficientnet3_1.h5")#tf.keras.applications.efficientnet.EfficientNetB3(weights=None, classes=10, input_tensor=Input(shape=(img_dim, img_dim, 3)))
model.summary()
...
model_path = os.path.join(checkpoint_path, 'study_efficientnet3_1.h5')
...
results.to_csv("./submission_4_1.csv",index=False)