...
channels = 3
std_shape = (224, 224, channels) # 输入尺寸, std_shape[0]: img_rows, std_shape[1]: img_cols
...
conv_7 = Conv2D(21, kernel_size = (3, 3), activation = "sigmoid", padding = "same", name = "conv_7")(up7)
