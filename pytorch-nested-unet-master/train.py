...
def parse_args():
    ...
    parser.add_argument('--input_w', default=256, type=int, help='images width')
    parser.add_argument('--input_h', default=256, type=int, help='images height')
    ...
    parser.add_argument('--img_ext', default='.png', help='images file extension')
