...
def make_pairs(images, labels):
	# initialize two empty lists to hold the (images, images) pairs and
	# labels to indicate if a pair is positive or negative
	pairImages = []
	pairLabels = []
	# calculate the total number of classes present in the dataset
	# and then build a list of indexes for each class masks that
	# provides the indexes for all examples with a given masks
