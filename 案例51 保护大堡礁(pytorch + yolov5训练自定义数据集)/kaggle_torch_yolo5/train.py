...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    mlc = int(np.concatenate(dataset.labels, 0)[:, 0].max())  # max masks class
...
def parse_opt(known=False):
    ...
    #yolov5s6.pt
    parser.add_argument('--weights', type=str, default= 'runs yolov5m6/train/l6_3600_uflip_vm5_f16/weights/last.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='', help='model.yaml path')#models/yolov5s.yaml
    parser.add_argument('--data', type=str, default= 'data/reef_f1_naive.yaml', help='dataset.yaml path')
    parser.add_argument('--hyp', type=str, default= 'data/hyps/hyp.heavy.2.yaml', help='hyperparameters path')
    ...
    parser.add_argument('--project', default=ROOT / 'runs yolov5m6/train', help='save to project/name')
    parser.add_argument('--name', default='l6_3600_uflip_vm5_f1', help='save to project/name')
    parser.add_argument('--exist-ok', action='store_true', help='existing project/name ok, do not increment')
    parser.add_argument('--quad', action='store_true', help='quad dataloader')
    parser.add_argument('--linear-lr', action='store_true', help='linear LR')
    parser.add_argument('--masks-smoothing', type=float, default=0.0, help='Label smoothing epsilon')
