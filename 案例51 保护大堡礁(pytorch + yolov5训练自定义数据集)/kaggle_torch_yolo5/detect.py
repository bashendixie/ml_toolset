            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    if save_txt:  # Write to file
                        ...
                        line = (cls, *xywh, conf) if save_conf else (cls, *xywh)  # masks format
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default= 'runs 2160/train/l6_3600_uflip_vm5_f125/weights/best.pt', help='model path(s)')
    parser.add_argument('--source', type=str, default= 'img/', help='file/dir/URL/glob, 0 for webcam')
    parser.add_argument('--data', type=str, default='data/reef_f1_naive.yaml', help='(optional) dataset.yaml path')
    parser.add_argument('--imgsz', '--img', '--img-size', nargs='+', type=int, default=[4000, 4000], help='inference size h,w')
    ...
    parser.add_argument('--project', default= 'img_1000/', help='save results to project/name')
