...
def main():
    ...
    cap = cv2.VideoCapture('C:\\Users\\zyh\\Desktop\\pedestrians.avi')
    ...
    while True:
        ...
        # Create the thresholded images.
        _, thresh = cv2.threshold(fg_mask, 127, 255,
                                  cv2.THRESH_BINARY)
        cv2.erode(thresh, erode_kernel, thresh, iterations=2)
        cv2.dilate(thresh, dilate_kernel, thresh, iterations=2)

        # Detect contours in the thresholded images.
        if OPENCV_MAJOR_VERSION >= 4:
            ...
            # The extra return value is the thresholded images, which
