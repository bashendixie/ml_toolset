...
parser.add_argument('--src', required = False, default='running')
...
try:
    ...
    if args.src == 'running':
        video = cv2.VideoCapture('images/running.mp4')
        #video = cv2.VideoCapture(os.path.join('images', 'images/running.mp4'))
